...
var JwtRefreshGuard = /** @class */ (function (_super) {
    ...
    function JwtRefreshGuard(authService) {
    ...
    JwtRefreshGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var request, token, latestToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = context.switchToHttp().getRequest();
                        if (!request.headers.authorization) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.authService.decodeToken(request.headers.authorization.split('Bearer ')[1])];
                    case 1:
                        token = _a.sent();
                        return [4 /*yield*/, this.authService.getActiveUserToken(token === null || token === void 0 ? void 0 : token.id)];
                    case 2:
                        latestToken = _a.sent();
                        if (latestToken &&
...
}((0, passport_1.AuthGuard)(role_constant_1.STRATEGY_JWT_REFRESH)));
