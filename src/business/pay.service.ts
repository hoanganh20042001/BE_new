...
import { sendAccountVerificationInput } from 'src/mail-bulk/mail-bulk.input';
...
export class PayService {
  ...
  async createPay(input: createPayDto) {
    ...
    // this.gateway.sendMessage(findUser);
    ...
    //   cost: cost,
    // });
    const inputsend=new sendAccountVerificationInput();
    inputsend.cost=cost;
