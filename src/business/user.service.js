...
var UserService = /** @class */ (function () {
    ...
    //   }
    // }
    UserService.prototype.listAllClient = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var search, limit, page, listUser, _a, list, count, error_1;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (search) {
                            ...
                            listUser.andWhere('( b.name LIKE :search OR b.description LIKE :search )', { search: "%".concat(search, "%") });
                        }
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
    ...
    UserService.prototype.getDetailUser = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var UserId, User;
    ...
    UserService.prototype.updateUser = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var findUserById, updatedItem;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne(payload.UserId)];
                    case 1:
                        findUserById = _a.sent();
                        if (!findUserById) {
                            throw new common_1.BadRequestException("User_is_not_exist");
                        }
                        updatedItem = __assign(__assign({}, findUserById), payload);
                        return [4 /*yield*/, this.userRepository.save(updatedItem)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    UserService.prototype.deleteUser = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var UserId, User;
            return __generator(this, function (_a) {
                switch (_a.label) {
