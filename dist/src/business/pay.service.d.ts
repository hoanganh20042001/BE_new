...
export declare class PayService {
    ...
    constructor(payRepository: PayRepository, orderRepository: OrderRepository, productRepository: ProductRepository, discountRepository: DiscountRepository, userRepository: UserRepository, mailService: MailService, mailBulkService: MailBulkService);
