...
export declare class ProductService {
    ...
    constructor(productRepository: ProductRepository, brandRepository: BrandRepository, typeRepository: TypeRepository, categoryRepository: CategoryRepository, minioService: MinioService);
